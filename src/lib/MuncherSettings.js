...
const MuncherSettings = {
  ...
  getCharacterImportSettings: () => {
    ...
    const itemEffectText = `Generate ActiveEffects for a character's equipment. This is intended for highly automated games only. Doesn't include AC effects on armor, but will for things like the Ring of Protection. ${basicEffectsText}`;
