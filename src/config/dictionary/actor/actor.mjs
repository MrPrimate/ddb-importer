export const ACTOR = {
  class: {
    "2104": [
      ...
      { name: "Barbarian", multiclassSkill: 0, multiclassTool: 0 },
      { name: "Blood Hunter", multiclassSkill: 0, multiclassTool: 0 },
      { name: "Blood Hunter (archived)", multiclassSkill: 0, multiclassTool: 0 },
      { name: "Cleric", multiclassSkill: 0, multiclassTool: 0 },
      { name: "Druid", multiclassSkill: 0, multiclassTool: 0 },
      { name: "Fighter", multiclassSkill: 0, multiclassTool: 0 },
      { name: "Hunter", multiclassSkill: 0, multiclassTool: 0 },
      { name: "Paladin", multiclassSkill: 0, multiclassTool: 0 },
      { name: "Ranger", multiclassSkill: 1, multiclassTool: 0 },
      { name: "Rogue", multiclassSkill: 1, multiclassTool: 0 },
      { name: "Sorcerer", multiclassSkill: 0, multiclassTool: 0 },
      { name: "Warlock", multiclassSkill: 0, multiclassTool: 0 },
      { name: "Wizard", multiclassSkill: 0, multiclassTool: 0 },
      { name: "Monk", multiclassSkill: 0, multiclassTool: 0 },
      { name: "Illrigger", multiclassSkill: 0, multiclassTool: 0 },
    ],
    "2024": [
      { name: "Artificer", multiclassSkill: 0, multiclassTool: 0 },
