...
export const SRD_COMPENDIUM_LOOKUPS = {
  "2014": [
    ...
    { type: "races", name: "dnd5e.origins24" },
    { type: "species", name: "dnd5e.origins24" },
    { type: "traits", name: "dnd5e.origins24" },
    { type: "features", name: "dnd5e.classes24" },
    { type: "feat", name: "dnd5e.feats24" },
    { type: "feats", name: "dnd5e.feats24" },
    { type: "classes", name: "dnd5e.classes24" },
    { type: "subclasses", name: "dnd5e.classes24" },
    { type: "weapon", name: "dnd5e.equipment24" },
    { type: "consumable", name: "dnd5e.equipment24" },
    { type: "tool", name: "dnd5e.equipment24" },
    { type: "loot", name: "dnd5e.equipment24" },
    { type: "container", name: "dnd5e.equipment24" },
    { type: "spell", name: "dnd5e.spells" },
    { type: "equipment", name: "dnd5e.equipment24" },
    { type: "monsters", name: "dnd5e.actors24" },
    { type: "monsterfeatures", name: "dnd5e.monsterfeatures24" },
    { type: "backgrounds", name: "dnd5e.origins24" },
  ],
};
