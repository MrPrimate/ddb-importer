const DICTIONARY = {
  ...
  character: {
    ...
    damageAdjustments: [
      ...
      { id: 1, type: 4, kind: "immunity", name: "Blinded", value: "blinded" },
      { id: 2, type: 4, kind: "immunity", name: "Charmed", value: "charmed" },
      { id: 3, type: 4, kind: "immunity", name: "Deafened", value: "deafened" },
      { id: 4, type: 4, kind: "immunity", name: "Exhaustion", value: "exhaustion" },
      { id: 5, type: 4, kind: "immunity", name: "Frightened", value: "frightened" },
      { id: 6, type: 4, kind: "immunity", name: "Grappled", value: "grappled" },
      { id: 7, type: 4, kind: "immunity", name: "Incapacitated", value: "incapacitated" },
      { id: 8, type: 4, kind: "immunity", name: "Invisible", value: "invisible" },
      { id: 9, type: 4, kind: "immunity", name: "Paralyzed", value: "paralyzed" },
      { id: 10, type: 4, kind: "immunity", name: "Petrified", value: "petrified" },
      { id: 11, type: 4, kind: "immunity", name: "Poisoned", value: "poisoned" },
      { id: 12, type: 4, kind: "immunity", name: "Prone", value: "prone" },
      { id: 13, type: 4, kind: "immunity", name: "Restrained", value: "restrained" },
      { id: 14, type: 4, kind: "immunity", name: "Stunned", value: "stunned" },
      { id: 15, type: 4, kind: "immunity", name: "Unconscious", value: "unconscious" },
