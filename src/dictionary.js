const DICTIONARY = {
  ...
  character: {
    class: [
      { name: "Artificer", mulitclassSkill: 0 },
      { name: "Bard", mulitclassSkill: 1 },
      { name: "Barbarian", mulitclassSkill: 0 },
      { name: "Blood Hunter", mulitclassSkill: 0 },
      { name: "Blood Hunter (archived)", mulitclassSkill: 0 },
      { name: "Cleric", mulitclassSkill: 0 },
      { name: "Druid", mulitclassSkill: 0 },
      { name: "Fighter", mulitclassSkill: 0 },
      { name: "Hunter", mulitclassSkill: 0 },
      { name: "Paladin", mulitclassSkill: 0 },
      { name: "Ranger", mulitclassSkill: 1 },
      { name: "Rogue", mulitclassSkill: 1 },
      { name: "Sorcerer", mulitclassSkill: 0 },
      { name: "Warlock", mulitclassSkill: 0 },
      { name: "Wizard", mulitclassSkill: 0 },
      { name: "Monk", mulitclassSkill: 0 },
    ],
    abilities: [
    ...
    damageAdjustments: [
      ...
      { id: 30, type: 2, kind: "immunity", name: "Bludgeoning, Piercing, and Slashing from Nonmagical Attacks that aren't Silvered", foundryValue: "physical", foundryValues: { value: ["bludgeoning", "piercing", "slashing"], bypass: ["sil"] } },
      { id: 31, type: 2, kind: "immunity", name: "Bludgeoning, Piercing, and Slashing from Nonmagical Attacks that aren't Adamantine", foundryValue: "physical", foundryValues: { value: ["bludgeoning", "piercing", "slashing"], bypass: ["ada"] } },
      { id: 32, type: 2, kind: "immunity", name: "Piercing and Slashing from Nonmagical Attacks that aren't Adamantine", foundryValue: "physical", foundryValues: { value: ["piercing", "slashing"], bypass: ["ada"] } },
    ...
    proficiencies: [
      // Armor
      { name: "Studded Leather", type: "Armor", subType: "Light Armor", foundryValue: "studded" },
      { name: "Scale Mail", type: "Armor", subType: "Medium Armor", foundryValue: "scalemail" },
      { name: "Shield", type: "Armor", subType: "Shield", foundryValue: "shield" },
      { name: "Padded", type: "Armor", subType: "Light Armor", foundryValue: "padded" },
      { name: "Leather", type: "Armor", subType: "Light Armor", foundryValue: "leather" },
      { name: "Hide", type: "Armor", subType: "Medium Armor", foundryValue: "hide" },
      { name: "Chain Shirt", type: "Armor", subType: "Medium Armor", foundryValue: "chainshirt" },
      { name: "Breastplate", type: "Armor", subType: "Medium Armor", foundryValue: "breastplate" },
      { name: "Half Plate", type: "Armor", subType: "Medium Armor", foundryValue: "halfplate" },
      { name: "Ring Mail", type: "Armor", subType: "Heavy Armor", foundryValue: "ringmail" },
      { name: "Chain Mail", type: "Armor", subType: "Heavy Armor", foundryValue: "chainmail" },
      { name: "Splint", type: "Armor", subType: "Heavy Armor", foundryValue: "splint" },
      { name: "Plate", type: "Armor", subType: "Heavy Armor", foundryValue: "plate" },
