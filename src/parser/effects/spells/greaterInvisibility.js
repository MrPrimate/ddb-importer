...
export function greaterInvisibilityEffect(document) {
  let effectGreaterInvisibilityNewActiveEffect = baseSpellEffect(document, document.name);
  const itemMacroText = `
...
`;
  ...
  effectGreaterInvisibilityNewActiveEffect.changes.push(generateMacroChange("@target"));
  document.effects.push(effectGreaterInvisibilityNewActiveEffect);
