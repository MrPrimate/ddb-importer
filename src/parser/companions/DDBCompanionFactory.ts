...
export default class DDBCompanionFactory {
  ...
  /**
   * Opens the summons compendium. Without one (a broken setup) the companions still parse so the
   * origin document keeps its summon activity, they just cannot be stored.
   */
  async init() {
    try {
