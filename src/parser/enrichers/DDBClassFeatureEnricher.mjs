...
export default class DDBClassFeatureEnricher extends DDBEnricherFactoryMixin {
  ...
  ENRICHERS = {
    ...
    "Defensive Flourish": ClassEnrichers.Bard.DefensiveFlourish,
    "Mobile Flourish": ClassEnrichers.Bard.MobileFlourish,
    "Slashing Flourish": ClassEnrichers.Bard.SlashingFlourish,
    ...
    "Improved Shadow Step": ClassEnrichers.Cleric.ImprovedShadowStep,
    ...
    "Pact of the Chain": ClassEnrichers.Warlock.PactOfTheChain,
    ...
    "Tactical Master": ClassEnrichers.Fighter.TacticalMaster,
