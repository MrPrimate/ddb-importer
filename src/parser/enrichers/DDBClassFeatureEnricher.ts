...
export default class DDBClassFeatureEnricher extends DDBEnricherFactoryMixin {
  ...
  override NAME_HINTS: Record<string, string> = {
    ...
    // Blood Hunter mutagen choice features; DDB names them for the plural parent feature
    "Formulas: Aether": "Formula: Aether",
    "Formulas: Alluring": "Formula: Alluring",
    "Formulas: Celerity": "Formula: Celerity",
    "Formulas: Conversant": "Formula: Conversant",
    "Formulas: Cruelty": "Formula: Cruelty",
    "Formulas: Deftness": "Formula: Deftness",
    "Formulas: Embers": "Formula: Embers",
    "Formulas: Gelid": "Formula: Gelid",
    "Formulas: Impermeable": "Formula: Impermeable",
    "Formulas: Mobility": "Formula: Mobility",
    "Formulas: Nighteye": "Formula: Nighteye",
    "Formulas: Percipient": "Formula: Percipient",
    "Formulas: Potency": "Formula: Potency",
    "Formulas: Precision": "Formula: Precision",
    "Formulas: Rapidity": "Formula: Rapidity",
    "Formulas: Reconstruction": "Formula: Reconstruction",
    "Formulas: Sagacity": "Formula: Sagacity",
    "Formulas: Shielded": "Formula: Shielded",
    "Formulas: Unbreakable": "Formula: Unbreakable",
    "Formulas: Vermillion": "Formula: Vermillion",
    ...
    "Unbroken Circle Spells": "Circle of the Spells",
    ...
    "Oath of the Hearth Spells": "Paladin Oath Spells",
    ...
    "Frost Spells": "Sorcerer Extra Spells",
    "Nemesis Spells": "Sorcerer Extra Spells",
    "Oni Spells": "Sorcerer Extra Spells",
    ...
    "Maverick Spells": "Artificer Spells",
