 ...
 * ends its turn there, which the region fires. The save for coming within 20 feet is a band
 * around a wall, a shape no template has, so it is a free save used by hand. The caster names
 * the creatures the wall spares, which a region cannot ask, so both saves reach enemies.
 */
