...
import { area, castPlacer, movementBehavior, movementDamage } from "./_SpellRegions";
 ...
 * moves through it, which is the caster's choice, so the placed area is that option and is
 * deleted when the plant is not thorny. The cube grows 5 feet per slot level above 4th.
 */
