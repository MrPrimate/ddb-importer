...
export default class WyrmsBreathGrenade extends DDBEnricherData {
  ...
  override get activity(): IDDBActivityData {
    ...
    return {
      ...
      activationCondition: "Repeat for a creature that enters the sphere or starts its turn there",
      data: {
        target: {
          override: true,
          affects: {
          ...
          template: {
            count: "1",
            contiguous: false,
            // thrown to a point in range, so a fixed sphere and not an emanation around the thrower
            type: "sphere",
            size: "15",
            units: "ft",
          },
        ...
        return [
          {
            ...
            changes: [
              ...
              DDBEnricherData.ChangeHelper.addChange("-2", 20, "system.abilities.dex.bonuses.save"),
        ...
        return [
          {
            name: metal.effectName,
            statuses: ["Paralyzed"],
            options: { transfer: false, expiry: "targetStart", durationRounds: 1, durationSeconds: 6 },
          },
        ];
      default:
        return [];
