    ...
    return [
      {
        ...
        // "until your next turn ends": the counted duration is only the backstop for the DAE expiry
        options: { transfer: false, expiry: "sourceEnd", durationRounds: 2, durationSeconds: 12 },
        atlChanges: [
