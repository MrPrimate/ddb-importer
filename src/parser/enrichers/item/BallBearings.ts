...
/**
 * Spilling the bag rolls nothing: it places a 10-foot square whose region fires the
 * "Ball Bearings Save" activity against each creature that enters, and that save knocks the
 * creature that fails it Prone.
 */
