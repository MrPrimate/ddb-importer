 ...
 * own cast activity with the emanation template, and the matching save is rolled
 * by hand on hostile creatures that start their turn inside; the effect lasts
 * until the aura ends and a creature that succeeds is immune for 24 hours (manual).
 */
