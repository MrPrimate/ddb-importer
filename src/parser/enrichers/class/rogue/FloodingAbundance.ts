 ...
 * nothing usable. Both are built from DDB here. Which 5-foot squares of the wax are burning is
 * tracked by hand, so the fire damage stays an activity the rogue uses.
 */
