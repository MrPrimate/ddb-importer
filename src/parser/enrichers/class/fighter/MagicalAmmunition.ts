    ...
    return [
      {
        ...
        changes: [
          DDBEnricherData.ChangeHelper.signedAddChange("-5", 20, "system.skills.prc.roll.bonus"),
          DDBEnricherData.ChangeHelper.signedAddChange("-5", 20, "system.skills.prc.passive"),
        ],
