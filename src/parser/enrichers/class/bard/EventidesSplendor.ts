 ...
 * this adds Shadow of the New Moon (the inspired creature turns Invisible until the start of
 * its next turn) and Lunar Vitality (spend a Bardic Inspiration die to heal that much extra and
 * grant +10 feet of speed until the end of the healed creature's next turn).
 */
    ...
    return [
      {
        ...
        statuses: ["Invisible"],
        // "remains Invisible until the start of its next turn"
        options: {
          durationSeconds: 6,
          durationRounds: 1,
          expiry: "targetStart",
