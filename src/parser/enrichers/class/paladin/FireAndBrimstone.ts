  ...
  override get effects(): IDDBEffectHint[] {
    return [
      ...
      },
      {
        ...
        statuses: ["Prone"],
        changes: [DDBEnricherData.ChangeHelper.movementMultiplierChange("0", 90)],
        options: { transfer: false, expiry: "targetStart", description: "Prone, and Speed 0 until the start of its next turn." },
      },
    ];
  }
