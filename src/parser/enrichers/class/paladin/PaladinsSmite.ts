...
/**
 * Paladin (2024) level 2: Divine Smite is always prepared and can be cast once per Long Rest
 ...
 */
export default class PaladinsSmite extends DDBEnricherData {
