...
export default class DDBMonsterFeatureEnricher extends DDBEnricherFactoryMixin<Record<string, string>> {
  ...
  GENERIC_FEATURE_NAME: Record<string, string> = {
    ...
    // Summon Undead's Putrid spirit; the companion parser trims "(Putrid Only)" after enrichment
    "Festering Aura (Putrid Only)": "Turn Start Aura Save",
    "Festering Aura": "Turn Start Aura Save",
    ...
    // actions and traits that leave an area on the map; a no-op where the text has no zone wording
    "Action 1: Sands of the Ancients": "Placed Zone",
    "Ash Cloud": "Placed Zone",
    "Aura of Blades": "Placed Zone",
    "Boggle Oil": "Placed Zone",
    "Briar Blast": "Placed Zone",
    "Cloud of Cards": "Placed Zone",
    "Dark Ground": "Placed Zone",
    "Death Burst": "Placed Zone",
    "Earth Eruption": "Placed Zone",
    "Earth-Shaking Movement": "Placed Zone",
    "Fetid Cloud": "Placed Zone",
    "Glacial Aura": "Placed Zone",
    "Grease Spray": "Placed Zone",
    "Gust of Wind": "Placed Zone",
    "Haboob": "Placed Zone",
    ...
    "Oil Puddle": "Placed Zone",
    "Poison Breath": "Placed Zone",
    "Poisonous Death": "Placed Zone",
    "Power Burst": "Placed Zone",
    "Reality-Altering Words": "Placed Zone",
    "Shard Breath": "Placed Zone",
    "Shroud of Souls": "Placed Zone",
    "Slime Spray": "Placed Zone",
    "Spell Mimicry": "Placed Zone",
    "Sticky Mud": "Placed Zone",
    "Stifling Webs": "Placed Zone",
    "Stone Spikes": "Placed Zone",
    "Toxic Smoke": "Placed Zone",
    "Transparent Trap": "Placed Zone",
    "Viscous Vicinity": "Placed Zone",
    "Web of Hair": "Placed Zone",
    "Wasting Wave": "Turn Start Aura Save",
    // creatures called onto the map: read from the text, and a no-op where the text names none,
    // since "Summon Demon" and its kin are a different list on every monster
  ...
  GENERIC_ENRICHERS: Record<string, EnricherConstructor> = {
    ...
    "Placed Zone": MonsterEnrichers.Generic.PlacedZone,
