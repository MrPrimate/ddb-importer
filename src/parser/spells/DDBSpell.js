...
export default class DDBSpell extends mixins.DDBActivityFactoryMixin {
  ...
  constructor({
    ...
    this.isCRSummonSpell2014 = DICTIONARY.companions.CR_SUMMONING_SPELLS_2014.includes(this.originalName);
    this.isSummons = this.isCompanionSpell || this.isCRSummonSpell2014;
  ...
  async _generateActivity({ hintsOnly = false, name = null, nameIdPostfix = null, typeOverride = null, typeFallback = "utility" } = {},
    ...
    else if (this.is2014 && this.isCRSummonSpell2014)
