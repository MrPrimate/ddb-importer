...
export default class AdvancementHelper {
  ...
  static rename(advancement: I5eAdvancement, { newName = null, identifier = null } = {}) {
    ...
    if (identifier) (advancement.configuration as I5eAdvConfig).identifier = identifier;
    return advancement;
  }
  ...
  static addAdditionalUses(advancement: I5eAdvancement) {
    ...
    for (const [key, value] of Object.entries((advancement.configuration as I5eAdvScaleValueConfig).scale ?? {})) {
      ...
      update.configuration.scale[key] = {
        value: (value as I5eAdvScaleValueDiceEntry & { die?: { n?: number } }).die?.n ?? (value as I5eAdvScaleValueDiceEntry).number,
      };
    }
  ...
  static addSingularDie(advancement: I5eAdvancement): I5eAdvancement {
    ...
    foundry.utils.setProperty(scaleValue, `configuration.identifier`, `${(advancement.configuration as I5eAdvConfig).identifier}-die`);
