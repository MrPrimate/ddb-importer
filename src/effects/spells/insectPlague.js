  ...
  effect.changes.push(
    {
      ...
      value:
        `label=${document.name} Turn End,turn=end, saveAbility=${document.data.save.ability}, saveDC=@attributes.spelldc, saveDamage=halfdamage, rollType=save, saveMagic=true, damageBeforeSave=false, damageRoll=(@item.level)d10, damageType=${document.data.damage.parts[0][1]}`,
      priority: "20",
    },
  );
