...
export function entangleEffect(document) {
  ...
  //     value:
  //       `label=${document.name} (Start of Turn),turn=start, saveAbility=${document.data.save.ability}, saveDC=@attributes.spelldc, rollType=save, saveMagic=true, saveRemove=true`,
  //     priority: "20",
  //   },
  // );
