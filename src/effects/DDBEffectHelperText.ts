...
export default class DDBEffectHelperText {
  ...
  /**
   * Damage parts a monster feature parsed for its text. Re-parsing the text via
   * DDBMonsterFeature is not possible here (it needs a ddbMonster and would pull the
   * monster parser into the enricher import graph); DDBEffectHelper keeps that fallback.
   */
