...
// The markup shapes below mirror captured DDB payloads; the flavour sentences are
// invented and only the charge and bonus lines keep DDB's phrasing, since those
// are what the stage parser reads.
// =============================================================================

// <h4>Stage</h4> headings, charges restated in full at every stage.
export const CABALS_RUIN = [
  "<p>A travelling cloak of dark wool with a tarnished clasp.</p>",
  "<h4>Dormant</h4>",
  ...
  "<p>When a spell targets you, you can use your reaction to draw some of its energy into the cloak. This property can’t be used again until you finish a short or long rest.</p>",
  "<h4>Awakened</h4>",
...
export const SPIRE_OF_CONFLUX = [
  "<p>A tall staff handed down through a long line of stewards.</p>",
  "<h4>Dormant</h4>",
...
export const JEWEL_OF_THREE_PRAYERS = [
  ...
  "<p><em><strong>Dormant State.</strong></em> In this state, the Jewel of Three Prayers is a plain golden disk.</p>",
  ...
  "<p><em><strong>Awakened State.&nbsp;</strong></em>In this state, the jewel has been blessed once.</p>",
  "<ul><li>The bonus that the jewel confers to your AC increases to +2.</li><li>Its number of charges increases to 5.</li></ul>",
  "<p><em><strong>Exalted State.</strong></em> In this state, the jewel has been blessed twice.</p>",
...
export const NO_CHARGE_VESTIGE = [
  "<p>A sliver of broken glass fixed into a plain hilt.</p>",
