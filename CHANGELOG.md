...
- Active Auras support is removed. Aura Effects is the replacement. Several of the auras that were previosuly handled by AA or AE are now system native. If Aura Effects is installed then the system will use this over template/region attached effects in a lot of cases.
...
- Custom tool injection would not work with Epic Rolls. @minmaxguru @durham_dicer
...
- A selective filter option for Word Monster Updates. @crimsonedge

# 7.2.4
- Background bulk processing would fail.
- Artificer 2024 Plans Known was incorrectly generated by the system from the Items Known values.
...
- Kalashtar, Khoravar and Shifter parsing fixes
- Some combinations of settings could cause the muncher screen to fail to open, if you were no longer a patreon supporter. @worldcleaver
...
- The Spell-Storing Item now has a DDB Macro function to allow you to pick the spell and create an enchantment. (2024, 2014 coming soon).
...
- Some fallback and parsing improvements for failures during character feature munching. @cschwarzburg9284
